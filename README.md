Deviget Magento 2 Application
========================================================

| Env | FrontURL | AdminURL |
| --- | :------- | :------- |
| DEV | https://app.deviget.test/  | https://app.deviget.test/backend/  |

Other useful URLs on DEV:

* https://mailhog.warden.test/
* https://rabbitmq.deviget.test/
* https://elasticsearch.deviget.test/
...
In the below examples `~/Sites/deviget` is used as the path. Simply replace this with whatever path you will be running this project from. It is recommended however to deploy the project locally to a case-sensitive volume.

 1. Clone the project codebase.

        git clone -b develop https://github.com/ernesthernandez/deviget-test \
            ~/Sites/deviget
